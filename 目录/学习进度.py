...
└── 13.git+路飞学城
    ...
    ├── day126
    │   ├── 01 python fullstack s9day126 今日内容概要.mp4
    │   ├── 02 python fullstack s9day126 内容回顾和补充：scrapy.mp4
    │   ├── 03 python fullstack s9day126 内容回顾和补充：网络和并发编程.mp4
    │   ├── 04 python fullstack s9day126 scrapy框架：pipeline做持久化（一）.mp4
    │   ├── 05 python fullstack s9day126 scrapy框架：pipeline做持久化（二）.mp4
    │   ├── 06 python fullstack s9day126 scrapy框架：dupefilter做去重（一）.mp4
    │   ├── 07 python fullstack s9day126 scrapy框架：dupefilter做去重（二）.mp4
    │   ├── 08 python fullstack s9day126 scrapy框架：depth深度控制.mp4
    │   ├── 09 python fullstack s9day126 scrapy框架：手动处理cookie.mp4
    ├── day127
    │   ├── 01 python fullstack s9day127 今日内容概要.mp4
    │   ├── 02 python fullstack s9day127 内容回顾：爬虫.mp4
    │   ├── 03 python fullstack s9day127 内容回顾：并发和网络.mp4
    │   ├── 04 python fullstack s9day127 scrapy框架：起始请求定制.mp4
    │   ├── 05 python fullstack s9day127 scrapy框架：深度和优先级.mp4
    │   ├── 06 python fullstack s9day127 scrapy框架：内置代理.mp4
    │   ├── 07 python fullstack s9day127 scrapy框架：自定义代理.mp4
    │   ├── 08 python fullstack s9day127 scrapy框架：解析器.mp4
    ├── day128-算法
    │   ├── 1 算法基本概念与递归.mp4
    │   ├── 2 二分查找与Low B三人组.mp4
    │   ├── 3 快速排序.mp4
    ...
    │   └── 5 归并排序.mp4
    ├── day129
    │   ├── 01 python fullstack s9day129 今日内容概要.mp4
    │   ├── 02 python fullstack s9day129 内容回顾：爬虫.mp4
    │   ├── 03 python fullstack s9day129 内容回顾：并发.mp4
    │   ├── 04 python fullstack s9day129 scrapy框架：下载中间件.mp4
    │   ├── 05 python fullstack s9day129 scrapy框架：爬虫中间件.mp4
    │   ├── 06 python fullstack s9day129 scrapy框架：定制命令.mp4
    │   ├── 07 python fullstack s9day129 django信号.mp4
    │   ├── 08 python fullstack s9day129 flask信号.mp4
    │   ├── 09 python fullstack s9day129 scrapy框架：信号.mp4
    │   ├── 10 python fullstack s9day129 redis集合.mp4
    │   ├── 11 python fullstack s9day129 scrapy框架：基于redis去重.mp4
    │   ├── 12 python fullstack s9day129 scrapy-redis组件：去重规则.mp4
    ├── day130
    │   ├── 01 python fullstack s9day130 今日内容概要.mp4
    │   ├── 02 python fullstack s9day130 内容回顾.mp4
    │   ├── 03 python fullstack s9day130 redis01.mp4
    │   ├── 04 python fullstack s9day130 redis02.mp4
    │   ├── 05 python fullstack s9day130 redis03.mp4
    │   ├── 06 python fullstack s9day130 redis04.mp4
    │   ├── 07 python fullstack s9day130 redis05.mp4
    │   ├── 08 python fullstack s9day130 redis06.mp4
    │   ├── 09 python fullstack s9day130 redis07.mp4
    └── day131
        ├── 01 python fullstack s9day131 今日内容概要.mp4
        ├── 02 python fullstack s9day131 内容回顾：爬虫.mp4
        ├── 03 python fullstack s9day131 内容回顾：并发和网络.mp4
        ├── 04 python fullstack s9day131 爬虫之高性能相关（一）.mp4
        ├── 06 python fullstack s9day131 websocket协议介绍.mp4
        ├── 07 python fullstack s9day131 websocket示例：投票系统.mp4
        ├── 08 python fullstack s9day131 websocket原理剖析.mp4
        ├── 09 python fullstack s9day131 websocket总结.mp4

154 directories, 912 files
